...
package com.example.openvpn.api;
...
import com.example.openvpn.core.ConfigParser.ConfigParseError;
...
import com.example.openvpn.core.VPNLaunchHelper;
...
public class ExternalOpenVPNService extends Service implements StateListener {
    ...
    private static final String EXTRA_INLINE_PROFILE_ALLOW_VPN_BYPASS = "com.example.openvpn.api.ALLOW_VPN_BYPASS";
    ...
    private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub() {
        ...
        private void startProfile(VpnProfile vp)
        {
            ...
            if(vpnPermissionIntent != null || neddPassword != 0){
                ...
                shortVPNIntent.setClass(getBaseContext(), com.example.openvpn.LaunchVPN.class);
                shortVPNIntent.putExtra(com.example.openvpn.LaunchVPN.EXTRA_KEY, vp.getUUIDString());
                shortVPNIntent.putExtra(com.example.openvpn.LaunchVPN.EXTRA_HIDELOG, true);
