...
import com.example.openvpn.BuildConfig;
import com.example.openvpn.core.VpnStatus.LogLevel;
    ...
    private final ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className,
            ...
            try {
                ...
                if (service.queryLocalInterface("com.example.openvpn.core.IServiceStatus") == null) {
                    // Not a local service
