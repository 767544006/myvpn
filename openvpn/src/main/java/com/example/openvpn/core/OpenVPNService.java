...
import static com.example.openvpn.core.ConnectionStatus.LEVEL_CONNECTED;
import static com.example.openvpn.core.ConnectionStatus.LEVEL_WAITING_FOR_USER_INPUT;
import static com.example.openvpn.core.NetworkSpace.IpAddress;
...
import com.example.openvpn.activities.DisconnectVPN;
import com.example.openvpn.api.ExternalAppDatabase;
import com.example.openvpn.core.VpnStatus.ByteCountListener;
import com.example.openvpn.core.VpnStatus.StateListener;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    public static final String START_SERVICE = "com.example.openvpn.START_SERVICE";
    public static final String START_SERVICE_STICKY = "com.example.openvpn.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "com.example.openvpn.NOTIFICATION_ALWAYS_VISIBLE";
    public static final String DISCONNECT_VPN = "com.example.openvpn.DISCONNECT_VPN";
    ...
    public static final String EXTRA_CHALLENGE_TXT = "com.example.openvpn.core.CR_TEXT_CHALLENGE";
    public static final String EXTRA_CHALLENGE_OPENURL = "com.example.openvpn.core.OPENURL_CHALLENGE";
    private static final String PAUSE_VPN = "com.example.openvpn.PAUSE_VPN";
    private static final String RESUME_VPN = "com.example.openvpn.RESUME_VPN";
    ...
    private void showNotification(final String msg, String tickerText, @NonNull String channel,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel notificationChannel = new NotificationChannel(channel, CHANNEL_NAME, NotificationManager.IMPORTANCE_LOW);
    ...
    synchronized void unregisterDeviceStateReceiver(DeviceStateReceiver deviceStateReceiver) {
        if (mDeviceStateReceiver != null)
            try {
                ...
                // java.lang.IllegalArgumentException: Receiver not registered: com.example.openvpn.NetworkSateReceiver@41a61a10
                // Ignore for now ...
                iae.printStackTrace();
            }
    }
...
//        try {
//            Class<?> cl = Class.forName("com.example.openvpn.core.OpenVPNThreadv3");
...
//        return null;
    ...
    public ParcelFileDescriptor openTun() {
        ...
        setDisAllowedVpnPackages(builder);
    ...
    private void setDisAllowedVpnPackages(Builder builder){
        for (String s : OpenConnector.INSTANCE.getDisAllow()) {
            try {
    ...
    private void doSendBroadcast(String state, ConnectionStatus level) {
        ...
        vpnstatus.setAction("com.example.openvpn.VPN_STATUS");
