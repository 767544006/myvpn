...
import com.example.openvpn.api.ExternalCertificateProvider;

public class ExtAuthHelper {

    public static final String ACTION_CERT_CONFIGURATION = "com.example.openvpn.api.ExternalCertificateConfiguration";
    public static final String ACTION_CERT_PROVIDER = "com.example.openvpn.api.ExternalCertificateProvider";

    public static final String EXTRA_ALIAS = "com.example.openvpn.api.KEY_ALIAS";
    public static final String EXTRA_DESCRIPTION = "com.example.openvpn.api.KEY_DESCRIPTION";
